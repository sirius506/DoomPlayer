...
#define USBH_MAX_NUM_ALT_INTERFACES  5U
#define	USBH_MAX_NUM_IFDESC	     12U
...
/*----------   -----------*/
#define USBH_MAX_NUM_SUPPORTED_CLASS      0x5U
...
#define HOST_FS 		1
  ...
  #define USBH_PROCESS_STACK_SIZE    ((uint16_t)400)
#endif /* (USBH_USE_OS == 1) */
