...
lv_obj_t *music_player_create(const AUDIO_DEVCONF *audio_devconfig, lv_group_t *g, lv_style_t *btn_style, lv_indev_t *keypad_dev)
{
  ...
  play_frequency = audio_devconfig->pseudoRate;
