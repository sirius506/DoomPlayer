...
typedef struct _ConfigurationDescriptor
{
  ...
  USBH_InterfaceDescTypeDef        Itf_Desc[USBH_MAX_NUM_IFDESC];
}
USBH_CfgDescTypeDef;
...
typedef struct sUSBH_Class
{
  const char          *Name;
  uint8_t             ClassCode;
  USBH_StatusTypeDef(*Init)(struct sUSBH_Class *pclass, struct _USBH_HandleTypeDef *phost);
  USBH_StatusTypeDef(*DeInit)(struct sUSBH_Class *pclass, struct _USBH_HandleTypeDef *phost);
  USBH_StatusTypeDef(*Requests)(struct sUSBH_Class *pclass, struct _USBH_HandleTypeDef *phost);
  USBH_StatusTypeDef(*BgndProcess)(struct sUSBH_Class *pclass, struct _USBH_HandleTypeDef *phost);
  USBH_StatusTypeDef(*SOFProcess)(struct sUSBH_Class *pclass, struct _USBH_HandleTypeDef *phost);
  void                *pData;
...
#define	EVF_URB_IDLE		0x8000
#define	EVF_URB_DONE		0x4000
#define	EVF_URB_NOTREADY	0x2000
#define	EVF_URB_NYET		0x1000
#define	EVF_URB_ERROR		0x0800
#define	EVF_URB_STALL		0x0400
#define	EVF_URB_MASK		0xFC00
#define	EVF_HID_SOF		0x0001
